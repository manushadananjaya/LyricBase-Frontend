...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(auth)` | `/(tabs)` | `/ArtistDetails` | `/Artists` | `/Chords` | `/CreatePlaylist` | `/EditPlaylist` | `/Home` | `/Index` | `/Playlists` | `/Profile` | `/Search` | `/SongDetails` | `/_sitemap` | `/sign-in` | `/sign-up`;
