...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(auth)` | `/(tabs)` | `/ArtistDetails` | `/Artists` | `/Chords` | `/ChordsDetails` | `/CreatePlaylist` | `/EditPlaylist` | `/Home` | `/Index` | `/OfflineDownloads` | `/PlaylistDetails` | `/Playlists` | `/Profile` | `/RequestLyricsChords` | `/Search` | `/SelectedSongScreen` | `/SongDetails` | `/WelcomeScreen` | `/_sitemap` | `/forgot-password` | `/otp-verify` | `/password-reset` | `/sign-in` | `/sign-up`;
