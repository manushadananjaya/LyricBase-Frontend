...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(auth)` | `/(tabs)` | `/ArtistDetails` | `/Artists` | `/Chords` | `/CreatePlaylist` | `/EditPlaylist` | `/Home` | `/Index` | `/PlaylistDetails` | `/Playlists` | `/Profile` | `/Search` | `/SelectedSongScreen` | `/SongDetails` | `/_sitemap` | `/sign-in` | `/sign-up`;
